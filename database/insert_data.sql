...
-- User Table
INSERT INTO User (firstname, lastname, email, password_hash) VALUES
...
('123 Main St', 'Boston', 'MA', '02115', 'USA'),
('456 Oak Ave', 'Cambridge', 'MA', '02139', 'USA'),
('789 Pine Rd', 'Brookline', 'MA', '02445', 'USA'),
('321 Elm Street', 'Somerville', 'MA', '02143', 'USA'),
('654 Maple Dr', 'Newton', 'MA', '02458', 'USA'),
('987 Cedar Ln', 'Watertown', 'MA', '02472', 'USA'),
('147 Birch Ave', 'Arlington', 'MA', '02474', 'USA'),
('258 Willow St', 'Medford', 'MA', '02155', 'USA'),
('369 Spruce Ct', 'Quincy', 'MA', '02169', 'USA'),
('741 Ash Blvd', 'Waltham', 'MA', '02451', 'USA'),
('852 Poplar Way', 'Malden', 'MA', '02148', 'USA'),
('963 Cherry Ln', 'Revere', 'MA', '02151', 'USA'),
('159 Magnolia Dr', 'Belmont', 'MA', '02478', 'USA'),
('357 Sycamore St', 'Lexington', 'MA', '02420', 'USA'),
('486 Redwood Pl', 'Needham', 'MA', '02492', 'USA');
...
-- Utility
INSERT INTO Utility (provider_name, type) VALUES
...
-- Insert Moves
INSERT INTO Move (user_id, title, move_date, status, from_address_id, to_address_id, created_at) VALUES
-- USER 1: John Doe 
(1, 'Moving to Cambridge', '2025-12-01', 'packing', 1, 2, '2025-10-15 10:30:00'),

-- USER 2: Jane Smith (2 moves)
(2, 'Upgrading to Bigger Place', '2025-11-25', 'in_transit', 4, 5, '2025-09-10 14:20:00'),
(2, 'First Move to Boston', '2023-08-01', 'done', 6, 4, '2023-05-12 11:00:00'),

-- USER 3: Mike Johnson 
(3, 'Downtown to Suburbs', '2024-03-10', 'done', 9, 7, '2024-01-05 16:45:00'),

-- USER 4: Sarah Williams 
(4, 'First Home Purchase', '2025-10-01', 'done', 10, 11, '2025-07-15 16:45:00'),

-- USER 5: Tom Brown (2 moves)
(5, 'Student Housing to Apartment', '2023-12-15', 'done', 14, 12, '2023-10-01 13:30:00');


-- Insert Rooms
-- MOVE 1: John - Moving to Cambridge (packing)
INSERT INTO Room (name, floor, move_id) VALUES
('Living Room', 1, 1),
('Kitchen', 1, 1),
('Dining Room', 1, 1),
('Master Bedroom', 2, 1),
...
INSERT INTO Box (label_code, room_id, is_fragile, weight, status) VALUES
...
(2, 11), -- JD-LIV-002: Decorations (can have multiple categories!)
...
INSERT INTO Item (box_id, name, quantity, est_value) VALUES
...
-- Gas
(2, 1, 'NG-789012-JD', '2025-11-30', '2025-12-01', 'requested'),
-- Internet - Comcast
(3, 1, 'COM-345678-JD', '2025-11-30', '2025-12-01', 'confirmed'),
-- Water
...
-- Gas
(3, 2, 'NG-321654-JS', '2025-11-24', '2025-11-25', 'active'),
...
-- Gas
(3, 4, 'NG-MJ-555', '2024-03-09', '2024-03-10', 'active'),
-- Internet - Comcast
...
-- Gas
(2, 5, 'NG-SW-888', '2025-09-30', '2025-10-01', 'active'),
-- Internet - Verizon Fios
...
-- Internet - Starry (modern internet)
...
-- MOVE 1: John - Moving to Cambridge (packing) - Dec 1, 2025
-- ========================================
INSERT INTO Appointment (move_id, title, description, apt_date, apt_time, contact_person, contact_phone, status) VALUES
-- Pre-move appointments
...
(2, 'Furniture Delivery', 'New couch delivery from Bob\'s Furniture', '2025-11-27', '13:00:00', 'Bob\'s Delivery', '617-555-0800', 'scheduled');
...
-- MOVE 1: John - Moving to Cambridge (packing) - Dec 1, 2025
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(1, 'Lease Agreement', 'https://storage.movemind.com/docs/john_doe/lease_cambridge_2025.pdf', '2025-10-16 09:30:00'),
(1, 'Moving Insurance', 'https://storage.movemind.com/docs/john_doe/insurance_policy_001.pdf', '2025-10-18 14:20:00'),
(1, 'Inventory List', 'https://storage.movemind.com/docs/john_doe/inventory_move1.xlsx', '2025-11-01 10:45:00'),
(1, 'Utility Transfer Confirmation', 'https://storage.movemind.com/docs/john_doe/utility_confirms.pdf', '2025-11-05 16:15:00'),
(1, 'Moving Company Contract', 'https://storage.movemind.com/docs/john_doe/boston_movers_contract.pdf', '2025-10-20 11:00:00'),
(1, 'Parking Permit', 'https://storage.movemind.com/docs/john_doe/cambridge_parking_permit.pdf', '2025-11-10 13:30:00'),
(1, 'Security Deposit Receipt', 'https://storage.movemind.com/docs/john_doe/security_deposit_old_apt.pdf', '2025-10-15 15:45:00');

-- ========================================
-- MOVE 2: Jane - Upgrading to Bigger Place (in_transit) - Nov 25, 2025
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(2, 'Lease Agreement', 'https://storage.movemind.com/docs/jane_smith/lease_newton_2025.pdf', '2025-09-12 10:00:00'),
(2, 'Moving Insurance', 'https://storage.movemind.com/docs/jane_smith/insurance_002.pdf', '2025-09-15 11:30:00'),
(2, 'Moving Quote', 'https://storage.movemind.com/docs/jane_smith/elite_movers_quote.pdf', '2025-09-20 14:45:00'),
(2, 'Utility Setup Confirmation', 'https://storage.movemind.com/docs/jane_smith/verizon_setup.pdf', '2025-11-01 09:15:00'),
(2, 'Keys Handover Receipt', 'https://storage.movemind.com/docs/jane_smith/keys_receipt.pdf', '2025-11-24 16:30:00'),
(2, 'Moving Day Checklist', 'https://storage.movemind.com/docs/jane_smith/moving_checklist.pdf', '2025-11-20 08:00:00');

-- ========================================
-- MOVE 3: Jane - First Move to Boston (done) - Aug 1, 2023
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(3, 'Lease Agreement', 'https://storage.movemind.com/docs/jane_smith/lease_somerville_2023.pdf', '2023-07-15 10:30:00'),
(3, 'Move Receipt', 'https://storage.movemind.com/docs/jane_smith/budget_movers_receipt.pdf', '2023-08-01 17:00:00'),
(3, 'RCN Internet Contract', 'https://storage.movemind.com/docs/jane_smith/rcn_contract.pdf', '2023-07-28 14:20:00');

-- ========================================
-- MOVE 4: Mike - Downtown to Suburbs (done) - Mar 10, 2024
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(4, 'Lease Agreement', 'https://storage.movemind.com/docs/mike_johnson/lease_arlington_2024.pdf', '2024-02-10 11:00:00'),
(4, 'Home Inspection Report', 'https://storage.movemind.com/docs/mike_johnson/home_inspection_report.pdf', '2024-03-06 15:30:00'),
(4, 'Moving Contract', 'https://storage.movemind.com/docs/mike_johnson/precision_movers_contract.pdf', '2024-02-20 09:45:00'),
(4, 'Moving Receipt', 'https://storage.movemind.com/docs/mike_johnson/precision_movers_receipt.pdf', '2024-03-10 18:30:00'),
(4, 'Utility Bills', 'https://storage.movemind.com/docs/mike_johnson/final_utility_bills.pdf', '2024-03-15 10:00:00'),
(4, 'Security Deposit Return', 'https://storage.movemind.com/docs/mike_johnson/security_deposit_return.pdf', '2024-04-05 14:20:00');

-- ========================================
-- MOVE 5: Sarah - First Home Purchase (done) - Oct 1, 2025
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(5, 'Home Purchase Agreement', 'https://storage.movemind.com/docs/sarah_williams/purchase_agreement.pdf', '2025-09-01 10:00:00'),
(5, 'Mortgage Documents', 'https://storage.movemind.com/docs/sarah_williams/mortgage_final.pdf', '2025-09-15 13:30:00'),
(5, 'Home Inspection Report', 'https://storage.movemind.com/docs/sarah_williams/inspection_report_malden.pdf', '2025-09-16 11:00:00'),
(5, 'Home Insurance Policy', 'https://storage.movemind.com/docs/sarah_williams/home_insurance.pdf', '2025-09-20 09:15:00'),
(5, 'Moving Receipt', 'https://storage.movemind.com/docs/sarah_williams/best_movers_receipt.pdf', '2025-10-01 19:00:00'),
(5, 'Title Insurance', 'https://storage.movemind.com/docs/sarah_williams/title_insurance.pdf', '2025-09-25 14:45:00'),
(5, 'Solar Panel Documentation', 'https://storage.movemind.com/docs/sarah_williams/solar_system_docs.pdf', '2025-10-05 16:20:00'),
(5, 'Closing Statement', 'https://storage.movemind.com/docs/sarah_williams/closing_statement.pdf', '2025-09-30 15:30:00'),
(5, 'Appliance Warranty', 'https://storage.movemind.com/docs/sarah_williams/washer_dryer_warranty.pdf', '2025-10-02 17:00:00');

-- ========================================
-- MOVE 6: Tom - Student Housing to Apartment (done) - Dec 15, 2023
-- ========================================
INSERT INTO Document (move_id, doc_type, file_url, uploaded_on) VALUES
(6, 'Lease Agreement', 'https://storage.movemind.com/docs/tom_brown/lease_belmont_2023.pdf', '2023-12-01 10:00:00'),
(6, 'Student Housing Checkout Form', 'https://storage.movemind.com/docs/tom_brown/dorm_checkout.pdf', '2023-12-14 14:30:00'),
(6, 'U-Haul Rental Receipt', 'https://storage.movemind.com/docs/tom_brown/uhaul_receipt.pdf', '2023-12-15 20:00:00'),
(6, 'Starry Internet Contract', 'https://storage.movemind.com/docs/tom_brown/starry_contract.pdf', '2023-12-10 11:45:00'),
(6, 'Security Deposit Receipt', 'https://storage.movemind.com/docs/tom_brown/security_deposit.pdf', '2023-12-01 15:00:00');
